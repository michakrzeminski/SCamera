 ...
 * </ul>
 */
public class CameraRaw extends Fragment
        implements FragmentCompat.OnRequestPermissionsResultCallback {

    Context context;
    public CameraRaw( Context Context) {
        context = Context;
    }
    ...
    public void onButton(AutoFitTextureView textureView, OrientationEventListener orientationListener) {
    ...
    public void offButton(OrientationEventListener orientationListener) {
        mOrientationListener = orientationListener;
